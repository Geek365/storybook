...
describe('manager.ui.components.down_panel.index', () => {
  test('should render only the selected panel with display set other than "none"', () => {
    ...
    const wrapper = shallow(<DownPanel panels={panels} onPanelSelect={onPanelSelect} selectedPanel={'test2'} />);
  ...
  test('should set onPanelSelected as onClick handlers of tabs', () => {
    ...
    const wrapper = shallow(<DownPanel panels={panels} onPanelSelect={onPanelSelect} selectedPanel={'test1'} />);
