...
describe('manager.ui.libs.filters', () => {
  describe('storyFilter', () => {
    ...
    test('should always return the selectedKind', () => {
      const stories = [{ kind: 'aa', namespaces: ['aa'], stories: ['bb'] }, { kind: 'bb', namespaces: ['bb'], stories: ['bb'] }];
    ...
    test('should always return the selectedKind with the single selectedStory', () => {
      const stories = [{ kind: 'aa', namespaces: ['aa'], stories: ['bb'] }, { kind: 'bb', namespaces: ['bb'], stories: ['bb', 'cc', 'dd'] }];
    ...
    test('should filter kinds correctly', () => {
      const stories = [{ kind: 'aa', namespaces: ['aa'], stories: ['bb'] }, { kind: 'bb', namespaces: ['bb'], stories: ['bb'] }, { kind: 'ss', namespaces: ['ss'], stories: ['bb'] }];
      const selectedKind = 'bb';
      const selectedStory = 'bb';
    ...
    test('should not sort stories by kind', () => {
      const stories = [{ kind: 'ss', namespaces: ['ss'], stories: ['bb'] }, { kind: 'aa', namespaces: ['aa'], stories: ['bb'] }, { kind: 'bb', namespaces: ['bb'], stories: ['bb'] }];
      const res = storyFilter(stories);
    ...
    test('should filter on story level', () => {
      const stories = [{ kind: 'aa', namespaces: ['aa'], stories: ['bb'] }, { kind: 'cc', namespaces: ['cc'], stories: ['dd'] }, { kind: 'ee', namespaces: ['ee'], stories: ['ff'] }];
    ...
    test('should filter out unmatched stories at lowest level', () => {
      const stories = [{ kind: 'aa', namespaces: ['aa'], stories: ['bb'] }, { kind: 'cc', namespaces: ['cc'], stories: ['dd'] }, { kind: 'ee', namespaces: ['ee'], stories: ['ff', 'gg'] }];
      const selectedKind = 'aa';
      const selectedStory = 'bb';
      const res = storyFilter(stories, 'ff', selectedKind, selectedStory);
    ...
    test('should be case insensitive at tree level', () => {
      const stories = [{ kind: 'Aa', namespaces: ['aA'], stories: ['bb'] }, { kind: 'cc', namespaces: ['cc'], stories: ['dd'] }];
      const selectedKind = 'aA';
    ...
    test('should be case insensitive at story level', () => {
      const stories = [{ kind: 'aa', namespaces: ['aa'], stories: ['bb'] }, { kind: 'cc', namespaces: ['cc'], stories: ['dd', 'eE'] }];
      const selectedKind = 'aa';
      const selectedStory = 'bb';
